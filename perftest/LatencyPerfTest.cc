...
size_t rdma::LatencyPerfTest::client_count;
size_t rdma::LatencyPerfTest::thread_count;
...
rdma::LatencyPerfClientThread::LatencyPerfClientThread(Memory *memory, std::vector<std::string>& rdma_addresses, std::string ownIpPort, std::string sequencerIpPort, size_t packet_size, int buffer_slots, size_t iterations_per_thread, WriteMode write_mode) {
