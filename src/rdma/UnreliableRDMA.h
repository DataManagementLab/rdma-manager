...
class UnreliableRDMA : public BaseRDMA {
 ...
 public:
    ...
    bool sendMCast(const rdmaConnID rdmaConnID, const void* memAddr, size_t size, bool signaled);
    bool receiveMCast(const rdmaConnID rdmaConnID, const void* memAddr, size_t size);
 ...
 private:
    ...
    bool getCmEvent(struct rdma_event_channel *channel, enum rdma_cm_event_type type,
